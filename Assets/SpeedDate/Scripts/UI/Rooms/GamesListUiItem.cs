...
namespace Barebones.MasterServer
{
    ...
    public class GamesListUiItem : MonoBehaviour
    {
        ...
        public void Setup(GameInfoPacket data)
        {
            ...
            {
                Online.text = $"{data.OnlinePlayers}/{data.MaxPlayers}";
            }
            else
            {
            ...
            MapName.text = data.Properties.ContainsKey(OptionKeys.MapName) 
                ? data.Properties[OptionKeys.MapName] : UnknownMapName;
        }
